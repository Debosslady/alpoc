  ...
  return (
    <footer className="border-t-4 border-brand-red bg-primary">
      <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
        ...
        <div className="mt-12 flex items-center justify-between border-t border-primary-foreground/15 pt-6">
          ...
          <p>
            <a
              href="https://wa.link/dbwzma"
              className="text-xs text-primary-foreground/60 hover:text-gold"
            >
              Designed by Lumeflo Solutions
            </a>
          </p> 
        </div>
      </div>
