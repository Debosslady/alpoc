...
const description = "Asset-Link Petroleum Optimization Company (RC 1393662) delivers integrated oil and gas solutions across Nigeria and sub-Saharan Africa, including production optimization, asset development, crude marketing, EPC, financing, logistics and manpower.";
...
export const metadata: Metadata = {
  ...
  keywords: ["petroleum asset optimization", "oil and gas Nigeria", "crude marketing", "EPC Nigeria", "production optimization"],
  openGraph: { type: "website", locale: "en_NG", url: siteUrl, siteName: "ALPOC", title, description, images: [{ url: "/hero-platform.jpg", width: 1600, height: 1104, alt: "Offshore oil and gas production platform at dusk" }] },
