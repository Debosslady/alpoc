    ...
    <>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              ...
              Development Planning, Engineering, Procurement, Oil Field Services, Logistics,
              Manpower, and Smart Technology deployment for hydrocarbon recovery.
            </p>
      ...
      <Section className="bg-secondary/50">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          <article className="rounded-2xl border-t-4 border-brand-blue bg-card p-8 shadow-card">
            <Compass className="size-9 text-brand-blue" />
            <h2 className="mt-5 text-xl font-bold text-primary">Our Vision</h2>
          ...
          <article className="rounded-2xl border-t-4 border-brand-red bg-card p-8 shadow-card">
            <Target className="size-9 text-brand-red" />
            <h2 className="mt-5 text-xl font-bold text-primary">Our Mission</h2>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          <article className="rounded-2xl border-t-4 border-brand-green bg-card p-8 shadow-card">
            <ShieldCheck className="size-9 text-brand-green" />
            <h2 className="mt-5 text-xl font-bold text-primary">Our Values</h2>
